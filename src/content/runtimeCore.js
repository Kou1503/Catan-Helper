(function bootstrap() {
  if (window.__CATAN_HELPER_OVERLAY_ACTIVE__) return;
  window.__CATAN_HELPER_OVERLAY_ACTIVE__ = true;

  injectPageHook();
  injectOverlayStyles();

  onDocumentReady(() => {
    const overlay = document.getElementById("catan-helper-overlay") || createOverlayRoot();
...
function injectPageHook() {
  if (document.getElementById("catan-helper-page-hook")) return;
  const script = document.createElement("script");
  script.id = "catan-helper-page-hook";
...
function injectOverlayStyles() {
  if (document.getElementById("catan-helper-overlay-styles")) return;
  const link = document.createElement("link");
  link.id = "catan-helper-overlay-styles";
  link.rel = "stylesheet";
