...
4. Confirm the version is `0.1.5` in the extension card details.
...
If your environment's PR button still opens an old link, use this latest commit hash to confirm you are on the newest revision.
